...
try:
    ...
    logging.warning(f"Scaling up with a RayCloneCell is not available as the `ray` dependency is not installed. "
                    f"If required, install it with `pip install pypipeline[ray]`")
else:
